...
class Paragraph {
  ...
  factory Paragraph.issuu(SimpleArticle pdfArticle) {
    return Paragraph(
        type: "issuu", rawContent: "", textSpans: List<TextSpan>(), imageUri: "", youtubeVideoId: "", soundcloudTrackId: "", soudcloudEmbedCode: "", hearthisAtTrackId: "", pdf: pdfArticle);
  }
  ...
  factory Paragraph.fromJson(Map<String, dynamic> json) {
    ...
    try {
      ...
      textAlign = textAlignString == 'left' ? TextAlign.left : textAlignString == 'center' ? TextAlign.center : TextAlign.right;
    } catch (exception) {
      /* ignore */
    }
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'fontFamily': fontFamily,
      'textAlign': textAlign == TextAlign.left ? 'left' : textAlign == TextAlign.center ? 'center' : 'right',
    };
  }
