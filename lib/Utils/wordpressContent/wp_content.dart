      ...
      return Container(
        ...
        child: RichText(
          text: TextSpan(
            ...
            style: DefaultTextStyle.of(context).style.copyWith(color: headingTextColor, fontFamily: paragraph.fontFamily, fontSize: fontSize + 5.0),
          ),
    ...
    /* paragraph - text */
      ...
      return Container(
        ...
        child: RichText(
          text: TextSpan(
            children: paragraph.textSpans,
            style: DefaultTextStyle.of(context).style.copyWith(color: paragraphTextColor, fontFamily: paragraph.fontFamily, fontSize: fontSize),
          ),
          textDirection: textDirection,
          textAlign: paragraph.textAlign,
        ),
    ...
    try {
      ...
      contentParts.forEach((c) {
        if (c.startsWith("image")) {
          ...
          processedParagraphs
              .add(parseQuoteHTML(paragraphContent, isArabic: isArabic, textAlign: quoteTextAlignment, fontFamily: fontFamily, arabicFontFamily: arabicFontFamily, baseFontSize: fontSize));
        } else if (c.startsWith("list")) {
          String listContent =
              c.substring(c.indexOf("-->") + 3, c.lastIndexOf("<!-- /wp:list -->")).replaceAll('\n', ' ').replaceAll('\r', ' ').replaceAll("<ol>", "").replaceAll("</ol>", "").replaceAll("</li>", "");
