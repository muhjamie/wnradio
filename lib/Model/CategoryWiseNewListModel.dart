class CategoriesWiseNewsList {
    ...
    CategoriesWiseNewsList({this.links, this.author, this.categories, this.commentStatus, this.content, this.date, this.dateGmt, this.excerpt, this.featuredMedia, this.format, this.guid, this.id, this.link,this.modified, this.modifiedGmt, this.pingStatus, this.slug, this.status, this.sticky, this.template, this.title, this.type});
